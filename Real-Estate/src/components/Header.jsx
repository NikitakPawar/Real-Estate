...
function Header() {
    return (
        <div className='min-h-screen mb-4 bg-cover bg-center w-full overflow-hidden' style={{ backgroundImage: "url('/header_img.png')" }} id='Header'>
            <Navbar />
            <motion.div
                ...
                viewport={{ once: true }}
                className='container text-center mx-auto py-80 px-100 md:px-60 lg:px-82 text-white'>
